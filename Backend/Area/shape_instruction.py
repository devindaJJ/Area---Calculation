...
def instruction_square():
    ...
    print("\n* To calculate the area of a Square, You Have to input Width and Height")
    print("* Surface Area = Square Width x Square Height")
    print("* w = Width (m)")
    
    try:
        width_of_square = float(input("Enter The Width Of Rectangle : "))
        square_obj = my_class.Square(width_of_square)
        area_of_square = square_obj.area_calculation()
        print("-------------------------------------")
        print("The Area Of The Square is ",area_of_square,'m\u00b2') 
        print("\n-------------------------------------") 
